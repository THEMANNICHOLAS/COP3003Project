...
void Entity::initSprite()
{
    ...
    //resize the sprite
    this->sprite.scale(2.f,2.f);        // putting (1.f,1.f) is going to be the original size of the image

    this->sprite.setPosition(960.f,540.f);        //set position of the sprite everytime in the middle of the screen
